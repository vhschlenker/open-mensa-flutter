...
class FavoriteCanteensPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _FavoriteCanteensPageState();
}

class _FavoriteCanteensPageState extends State<FavoriteCanteensPage> {
